...
private ["_zoneSize", "_westGroups", "_eastGroups", "_westVehicles", "_eastVehicles", "_a3ru_units", "_pos", "_group", "_vehicles", "_veh", "_vehPos"];
...
a3ru_markersArray = [_westGroups, _eastGroups];
a3ru_markersVehiclesArray = [_westVehicles, _eastVehicles];
